...
class NavigatorPushAction extends AppAction {
  ...
  @override
  String toString() => "NavigatorPushAction{$route}:{$data}";
}
...
class NavigatorReplaceAction extends AppAction {
  ...
  @override
  String toString() => "NavigatorReplaceAction{$route}:{$data}";
}

class NavigatorRootAction extends AppAction {
  final String route;
  final dynamic data;
  NavigatorRootAction(this.route, {this.data});

  @override
  String toString() => "NavigatorRootAction{$route}:{$data}";
}
...
class PushDialogAction extends AppAction {
  ...
  final bool autoHide;
  PushDialogAction(this.widgetBuilder,
      { this.context,  this.autoHide});
  @override
  String toString() => "PushDialogAction";
}
...
class PushedDialogAction extends AppAction {
  ...
  @override
  String toString() => "PushedDialogAction";
}
...
class PoppedDialogAction extends AppAction {
  ...
  @override
  String toString() => "PoppedDialogAction";
}

class NavigatorPopAction extends AppAction {
  @override
  String toString() => "NavigatorPopAction{}";
}
